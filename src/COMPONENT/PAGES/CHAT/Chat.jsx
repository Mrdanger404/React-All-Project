  ...
  return (
    ...
    <div className="h-screen ">
      <div className="h-screen flex flex-col items-center justify-center">
        ...
        <button onClick={handleBottom} className=" w-auto border border-black m-2 p-2 rounded-xl font-semibold hover:bg-blue-900">Go bottom</button>
              ...
              return <div key={index} className="flex flex-col w-full box-border">
                {uid == item.uid ? (
                  ...
                  <div className="flex flex-col p-5">
                    <div className="m-2">
                      <p className="w-56 bg-orange-600 p-4 float-left break-words rounded-3xl"><span className="font-bold">{item.user}</span> : {item.message}</p>
                    </div>
                    <div className="w-full">
          ...
          <div className="w-full flex flex-col items-center m-5" >
            ...
            <input type="file" accept="image/*"  onChange={handleImage} className="w-32 sm:w-min " />
